  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          <h1 className="text-4xl font-bold text-gray-800 mb-4">Free Computer Classes</h1>
          <div className="bg-teal-50 p-6 rounded-xl">
            <p className="text-xl text-gray-700 mb-4">
              Learning to use computers and navigate the internet is essential in today's digital world. Our community
              offers various free computer classes designed for beginners, with special sessions for seniors and those
              with limited technology experience.
            </p>
            <p className="text-xl text-gray-700 mb-4">
              Below you'll find the latest news about computer classes and digital literacy programs in your area. For
              information about our weekly classes at the community center, call (555) 123-4567 or visit us in person.
            </p>
        ...
        <h2 className="text-3xl font-bold text-gray-800 mb-8">Latest Computer Class News & Resources</h2>

        {/* Dynamic news grid component with improved topic specificity */}
        <NewsGrid topic="computer" title="Free Computer Classes" />
      </main>
