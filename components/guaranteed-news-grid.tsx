...
interface GuaranteedNewsGridProps {
  topic: string
  title?: string
  category?: string
}

export default function GuaranteedNewsGrid({ topic, title, category }: GuaranteedNewsGridProps) {
  ...
  const fetchNews = async () => {
    try {
      ...
      apiUrl.searchParams.append("category", topic)
      apiUrl.searchParams.append("limit", "9") // Get more articles for the grid

      console.log(`Fetching guaranteed news grid for topic: ${topic}`)
